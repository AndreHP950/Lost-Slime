...
Shader "Universal Render Pipeline/Particles/LitWithShadows"
{
    ...
    SubShader
    {
        ...
        // ------------------------------------------------------------------
        // 2) ShadowCaster Pass (adicionado para que as partículas lancem sombras)
        Pass
        {
            Name "ShadowCaster"
            ...
            // Este pass precisa compilar instancing se o seu sistema de partículas usar GPU instancing
            #pragma multi_compile_instancing

            // -------------------------------------
            // Shader Stages IDÊNTICOS ao URP/Lit ShadowCaster
